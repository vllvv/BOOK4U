...
<section class="page-section bg-none" id="portfolio">
    ...
    <div class="container">
        <div class="row">
            ...
            <nav class="navbar bg-body-tertiary">
			  ...
			  <div class="container-fluid center-div">
			    <ul class="nav justify-content-end">
				  <li class="nav-item">
				    <a class="nav-link active" aria-current="page" href="Admin.jsp">회원 관리</a>
				  </li>
				  <li class="nav-item">
            ...
            <form id="DeleteUser" action="AdminDeleteUserAction.jsp" method="post" onsubmit="return validateForm();" class="admin-form">
                <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
                    <thead>
                    
                        <tr>
                            <th colspan="6" style="background-color: #eeeeee; text-align: center;">회원관리</th>
                    	...
                    	<tr>
							...
							<script>
							    function handleSortingChange(select) {
							        ...
							        location.href = 'Admin.jsp?orderBy=' + selectedValue.split('_')[0] + '&orderDir=' + selectedValue.split('_')[1]+'&formName=DeleteUser';
							    }
							</script>
							</td>
				            ...
				            <script>
							    function searching() {
							        ...
							        location.href = 'Admin.jsp?searchField=' + searchField + '&searchText=' + searchText + '&formName=DeleteUser';
							    }
							</script>
							</tr>
                ...
                <table align="center">
                    ...
                    <tr align="center">
                        <td><input type="submit" class="btn btn-primary pull-right" value="회원삭제"></td>
                    </tr>
                </table>
            </form>
