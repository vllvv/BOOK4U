...
<body id="page-top">
        ...
        <div class="container">
                <div class="row">
                        <form method="post" action="writeAction.jsp" enctype="multipart/form-data" name="fileForm">
                                <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
                                        ...
                                        <tbody>
                                                ...
                                                <input id="button" type="submit" class="btn btn-primary pull-right" value="글 쓰기"  onclick="javascript:checkFile()">
