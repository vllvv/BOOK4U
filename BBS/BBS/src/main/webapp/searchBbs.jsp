...
<body id="page-top">
   ...
   <div class="container">
      ...
      <!-- 여기부터 -->
         ...
         <table class="pull-right" style="margin-bottom:5px; border-spacing: 5px; float:right;">
            <tr>
       ...
       <!-- 여기까지 -->
             ...
             <tr>
                 <th style="background-color: #eeeeee; text-align: center;">
                 	<a style="text-decoration: none;"
                 		href="searchBbs.jsp?pageNumber=<%= pageNumber %>&orderBy=bbsID&searchText=<%= searchText %>&orderDir=<%= (orderBy.equals("bbsID") && orderDir.equals("DESC")) ? "ASC" : "DESC" %>">
                         <font color="#595959">번호</font>
					        <%
					        if (orderBy.equals("bbsID")) {
					            if (orderDir.equals("ASC")) {
					        %>
					        <i class="fas fa-caret-up" style="color: gray;"></i>
					        <%
					        } else {
					        %>
                 ...
                 <th style="background-color: #eeeeee; text-align: center;">
					<a style="text-decoration: none;"
                 		href="searchBbs.jsp?pageNumber=<%= pageNumber %>&orderBy=bbsTitle&searchText=<%= searchText%>&orderDir=<%= (orderBy.equals("bbsTitle") && orderDir.equals("DESC")) ? "ASC" : "DESC" %>">                         
                 ...
                 <th style="background-color: #eeeeee; text-align: center;">
					<a style="text-decoration: none;"
                 		href="searchBbs.jsp?pageNumber=<%= pageNumber %>&orderBy=userID&searchText=<%= searchText%>&orderDir=<%= (orderBy.equals("userID") && orderDir.equals("DESC")) ? "ASC" : "DESC" %>">                         
                 ...
                 <th style="background-color: #eeeeee; text-align: center;">
					<a style="text-decoration: none;"
                 		href="searchBbs.jsp?pageNumber=<%= pageNumber %>&orderBy=bbsDate&searchText=<%= searchText%>&orderDir=<%= (orderBy.equals("bbsDate") && orderDir.equals("DESC")) ? "ASC" : "DESC" %>">
         ...
         %>
            <a href="searchBbs.jsp?pageNumber=<%=pageNumber + 1%>"
