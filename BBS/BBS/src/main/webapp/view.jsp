          ...
          <%= bbs.getBbsContent().replaceAll("\n", "<br>") %>
                   ...
                   <tr>
                       ...
                       <%
                            ...
                            String directory = "s3://h4ck-for-u-uploads/uploads/";
                            for (String file : fileList) {
                                if (file != null && !file.isEmpty() && !file.equals("null")) {
                                    String fileNameWithoutExtension = file.substring(0, file.lastIndexOf("."));
                                    out.write("<a href=\"" + request.getContextPath() + "/downloadAction?file=" + java.net.URLEncoder.encode(file, "UTF-8") + "\">" + fileNameWithoutExtension + "</a><br>");
                                }
                            }
                        %>
                       </td>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <%
             if(userID != null && uD.getRole(userID) == 1) { %>
             <a href="bbs.jsp" class="btn btn-primary">QNA목록</a>
             <a href="update.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">수정</a>
          <% } else if (userID != null && userID.equals(bbs.getUserID())) { %>
        ...
        <div class="col-lg-6 text-lg-end">
         <% if (uD.getRole(userID) == 0) { %>
          <a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">삭제</a>
        <%} else if (uD.getRole(userID) == 1) { %>
         <a href="AdminManagementQna.jsp" class="btn btn-primary">QNA관리</a>
         <% } %>
        </div>
      </div>
    </div>
